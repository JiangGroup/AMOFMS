from AMOFMS.DSPGM_MARTINI2.CGPredictionFromDSPGM import DSGPMtoCG
import os

smiles = 'CCCCCCCCCCCCCCCC(=O)OCC(COP(=O)([O-])OCC[N+](C)(C)C)OC(=O)CCCCCCCC=CCCCCCCCC'
json_dir = './json_folder'
CG_num_bead = 12
mol_json = DSGPMtoCG(smile=smiles, file_dir=json_dir, num_cg_bead=12, cluster_random_seed=189)
...
for molecule in molecules:
    mol_mapping = MappingToCGfromDSGPM(mol_name=molecule['molecule name'],
